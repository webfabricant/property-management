					...
					<aside class="widget">
						<div class="textwidget">
							<div class="home_wrapper">
								...
								<div id="home_preview">
									<div class="view_more sort_by"><span>sort by:</span><a href="#">newest</a> | <a href="#">popular</a></div>
									<div class="home_preview">
										<img src="{{asset('assets/images/templates/200x110.png')}}" alt="home">
										<div class="home_info">
											<h4>Title Example</h4>
											<ul>
										...
										<div class="home_footer"><a class="sale" href="{{ route('listing') }}">for sale</a><a href="{{ route('listing') }}" class="add">&#160;</a><span class="home_cost">$1,000<sup>/mo</sup></span></div>
									</div>
									<div class="home_preview">
										<img src="{{asset('assets/images/templates/200x110.png')}}" alt="home">
										<div class="home_info">
											<h4>Title Example</h4>
											<ul>
												<li>New York, 5th Ave.</li>
												<li>1 bedrooms, 1 bathroom</li>
												<li>140 sqft</li>
											</ul>
										</div>
										<div class="home_footer"><a class="rent" href="{{ route('listing') }}">for rent</a><span class="home_cost">$98,000</span></div>
									</div>
									<div class="home_preview">
										<img src="{{asset('assets/images/templates/200x110.png')}}" alt="home">
										<div class="home_info">
										...
										<div class="home_footer"><a class="sale" href="{{ route('listing') }}">for sale</a><a href="{{ route('listing') }}" class="add">&#160;</a><span class="home_cost">$125,600</span></div>
									</div>
									<div class="home_preview">
										<img src="{{asset('assets/images/templates/200x110.png')}}" alt="home">
										<div class="home_info">
										...
										<div class="home_footer"><a class="rent" href="{{ route('listing') }}">for rent</a><span class="home_cost">$1,000<sup>/mo</sup></span></div>
									</div>
									<div class="home_preview">
										<img src="{{asset('assets/images/templates/200x110.png')}}" alt="home">
										<div class="home_info">
									...
									<div class="home_preview">
										...
										<div class="home_footer"><a class="rent" href="{{ route('listing') }}">for rent</a><a href="{{ route('listing') }}" class="add">&#160;</a><span class="home_cost">$1,000<sup>/mo</sup></span></div>
									</div>
