					...
					<aside class="widget">
						<div class="textwidget">
							<div class="home_full_wrapper">
								<div class="back_to_results"><a class="more" href="{{ route('search_results') }}">back to search results</a></div>
									...
									<div class="home_content_full">
										...
										<div class="home_content_tab home_content_1 active">
											<div class="home_image">
												<img src="{{asset('assets/images/templates/420x320.png')}}" alt="home">
											</div>
											<div class="home_slides">
												<div class="prev"></div>
												<div class="thumbnails">
													<div id="thumbnails_holder">
														<img src="{{asset('assets/images/templates/110x80.png')}}" alt="home">
														<img src="{{asset('assets/images/templates/110x80.png')}}" alt="home">
														<img src="{{asset('assets/images/templates/110x80.png')}}" alt="home">
														<img src="{{asset('assets/images/templates/110x80.png')}}" alt="home">
														<img src="{{asset('assets/images/templates/110x80.png')}}" alt="home">
								...
								<div class="search_options home_info_full">
									...
									<div class="agent_details">
										<img src="{{asset('assets/images/templates/60x60.png')}}" alt="home">
										<div class="profile">
											<h4>Joe Doe</h4>
											<p><b>P.:</b> (555) 366 - 00 - 00<br>
											<b>E.:</b> mail@example.com</p>
