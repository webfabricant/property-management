...
<head>
	...
	<!-- Titles
	================================================== -->
	<title>Alexa Property Management Inc. Charlotte NC</title>
		...
		<div class="container-fluide">
			<div class="row">
				<div class="col-md-3">
					<div class="site-logo">
                        <a href="index.html">
                            <img src="assets/images/footer-logo.png" style="margin-left: 50px !important" alt="house" />
                        </a>
                    </div><!-- /.house-logo -->
				</div><!-- /.col-md-4 -->
                            ...
                            <div class="menu-content">
                                <ul class="menu-list">
                                    <li>
                                        ...
                                        <ul class="sub-menu">
                                            <li>
                                                <a href="#">Information for Tentants</a>
                                            </li>
                                            <li>
                                    ...
                                    <li>
                                        ...
                                        <ul class="sub-menu">
                                            <li>
                                                <a href="#">Maintenance Request Form</a>
                                            </li>
                                            <li>
                                                <a href="#">Online Payment</a>
                                            </li>
                                            <li>
                                                <a href="#">Utilities Information</a>
                                            </li>
                                            <li>
                                                <a href="#">Q&A</a>
                                            </li>
                                    ...
                                    <li>
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li>
                                                <a href="#">Property MGMT Agreement</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li>
           ...
           <div class="row">
               <div class="col-md-12">
                   <div class="bottom-content">
                       <p>Copyright  &copy;<?php echo date('Y'); ?> <a href="#">Alexa Property Management</a>  |  All rights reserved</p>
